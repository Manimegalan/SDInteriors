...
(function () {
  ...
  dropdownLinks.on("click", function (evt) {
    // evt.preventDefault();
    $(this).find("a").on("click", closeMenu);
...
(function () {
  ...
  var thHeroSliderCurrent = document.querySelector(
    ".__js_th-hero-slider-current"
  );
  var thHeroSliderTotal = document.querySelector(".__js_th-hero-slider-total");
  var thHeroSliderSlidesCount = document.querySelectorAll(
    ".__js_th-hero-slider .th-hero-slider__slide"
  ).length;
...
(function () {
  ...
  var thCarouselPrev = document.querySelector(
    ".__js_th-latest-projects__btn--prev"
  );
  var thCarouselNext = document.querySelector(
    ".__js_th-latest-projects__btn--next"
  );
  ...
  function initPriceSlider() {
    if (
      ...
      priceList.on("slideChange", function () {
        priceList.activeIndex === 0
          ? slider.addClass("hide-left")
          : slider.removeClass("hide-left");
        priceList.activeIndex === priceList.slides.length - 1
          ? slider.addClass("hide-right")
          : slider.removeClass("hide-right");
      });
    } else if (
...
(function () {
  $(window).on("load", function () {
    ...
    filterItem.on("click", function () {
      ...
      if (
        $(".__js_news-list-filter") &&
        $(".__js_news-list-filter").length > 0
      ) {
